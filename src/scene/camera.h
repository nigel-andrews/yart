...
namespace yart
{
    ...
    // Here, it is the renderer's job to abstract the screen size rendered and the camera only has to handle the normalized space
    class camera
    {
    public:
        ...
        void look_at(const glm::vec3& position, const glm::vec3& up, const glm::vec3& target);
